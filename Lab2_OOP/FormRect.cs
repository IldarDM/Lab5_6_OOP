...
namespace Lab5_OOP
{
    public partial class FormRect : Form
    {
        ...
        public FormRect(Button but)
        {
            InitializeComponent();
            this.but = but;
            for (int i = 0; i < FiguresContainer.RectanglesList.Count; i++)
            {
                figure_box.Items.Add(FiguresContainer.RectanglesList[i]); 
                figure_box.Items[i] = $"Rect{FiguresContainer.RectanglesList[i].number}";
            }
        ...
        private void Button_New_Cords_Click(object sender, EventArgs e)
        {
            ...
            {
                if (FiguresContainer.RectanglesList[figure_box.SelectedIndex] != null)
                {
                    Rectangle Rect = FiguresContainer.RectanglesList[figure_box.SelectedIndex];
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                Rectangle Rect = FiguresContainer.RectanglesList[figure_box.SelectedIndex];
                FiguresContainer.RectanglesList.Remove(Rect);
